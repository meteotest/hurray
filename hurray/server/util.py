...
def import_object(name):
    ...
    >>> import hurray.escape
    >>> import_object('hurray.escape') is hurray.escape
    True
    >>> import_object('hurray.escape.utf8') is hurray.escape.utf8
    True
    >>> import_object('hurray') is hurray
    True
    >>> import_object('hurray.missing_module')
