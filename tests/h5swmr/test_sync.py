...
from hurray.h5swmr.sync import reader, writer, redis_conn
...
class DummyResource(object):
    ...
    def read(self, worker_no, suicide=False):
        ...
        """
        pid = os.getpid()
        print("❤ {0}worker {1} (PID {2}) reading!"
    ...
    def write(self, worker_no):
        ...
        simulate writing
        """
        print("⚡ worker {0} writing!".format(worker_no))
        time.sleep(random.random())
...
class TestLocks(unittest.TestCase):
    ...
    def test_locks(self):
        ...
        def worker_read(i, resource):
            ...
            print("Worker {0}(pid {1}) attempts to read...".format(i, pid))
            if i % 13 == 1:
        ...
        def worker_write(i, resource):
            ...
            print("Worker {0}(pid {1}) tries to write...".format(i, pid))
            resource.write(i)
    ...
    #     def worker_read(i, resource):
    #         """ reading worker """
    #         print("Worker {0} attempts to read...".format(i))
    #         resource.read(i, suicide=True)

    #     def worker_write(i, resource):
    #         """ writing worker """
    #         print("Worker {0} tries to write...".format(i))
    #         resource.write(i)
